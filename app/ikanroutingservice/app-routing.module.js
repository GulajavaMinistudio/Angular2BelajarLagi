...
var dashboardcontoh_component_1 = require("./dashboardcontoh.component");
var hello_dashboard_routing_component_1 = require("./hello-dashboard-routing.component");
...
var routers = [
    ...
    {
        path: 'detail/:id',
        component: ikan_detail_component_1.IkanDetailComponent
    }
];
